...
export default function Summer() {
  const color = SEASON_COLORS.Summer.hover;
  const { i18n } = useTranslation();

  const isVI = i18n.language === "vi";

  // instant content switch
  const sections = isVI ? summerVI : summerEN;
    ...
    "
      ...
      `}
        ...
        <header className="max-w-3xl mx-auto px-6 pt-16 pb-10 text-center">
          ...
          >
            {isVI ? "Hà Nội · Tháng 5 – Tháng 8" : "Hanoi · May – August"}
          </motion.p>
          ...
          >
            {isVI ? "Hà Nội Mùa Hè" : "Hanoi in Summer"}
          </motion.h1>
          ...
          >
            {isVI
              ? "Thành phố không bao giờ ngừng sôi động, dù dưới cái nắng gay gắt nhất — hướng dẫn để tồn tại và tận hưởng Hà Nội ở trạng thái cuồng nhiệt nhất."
              : "A city that never slows down, even under the blazing sun — your guide to surviving and savoring Hanoi at its most electric"}
          </motion.p>
        </header>
